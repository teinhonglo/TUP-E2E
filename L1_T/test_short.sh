...
if [ ${stage} -le 0 ]; then
    for rtask in ${recog_set}; do
        ...
        data2json.sh --feat dump/$rtask/deltafalse/feats.scp --nlsyms data/lang_1char/train.txt data/${rtask} data/lang_1char/L1_T_train_sp_units.txt > dump/$rtask/deltafalse/data.json
    done
fi
if [ ${stage} -le 1 ]; then
    echo "decoding"
    ...
    ctc_weight=0.5
    lm_weight=0.2
    expdir=exp/train_lsm_pytorch_vggblstmp_e6_subsample1_2_2_1_1_unit320_proj320_d1_unit300_location_aconvc10_aconvf100_mtlalpha0.5_adadelta_sampprob0.0_bs10_mli800_mlo150
